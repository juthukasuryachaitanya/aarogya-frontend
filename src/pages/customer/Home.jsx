...
// 3. Marquee
const Marquee = ({ text }) => (
  <div className="relative flex overflow-x-hidden bg-green-900 py-3 text-white transform -rotate-1 origin-left border-y-4 border-yellow-400 z-20">
    <motion.div
...
// 4. Live Update Carousel
const LiveUpdateSection = ({ onAction }) => {
  ...
  const offers = [
    ...
    {
      id: "gym",
      title: "Gym Delivery Now Live",
      subtitle: "Post-workout bowls rich in Protein, Vitamins & Fiber.",
      highlight: "Fuel Your Recovery",
      icon: <FaDumbbell />, 
    ...
    },
    {
      ...
      subtitle: "Invite friends to Aarogya Harvest and earn 5% cashback on every order you refer.",
      highlight: "Get 5% cashback",
      icon: <FaUserFriends />,
  ...
  return (
    <div className="relative z-30 px-4 md:px-6 -mt-8 md:-mt-12 mb-8">
      <motion.div 
        layout
        className={`max-w-5xl mx-auto bg-gradient-to-r ${currentOffer.gradient} rounded-3xl p-1 shadow-2xl ${currentOffer.shadow} transition-colors duration-500 backdrop-blur-xl relative`}
      >
          ...
          <div className="relative h-full">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <button 
                  onClick={() => onAction(currentOffer.id)}
                  className="w-full md:w-auto px-8 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-black transition-transform active:scale-95 flex items-center justify-center gap-2 shrink-0"
                >
...
const AnimatedMenu = () => {
  const menuCategories = [
    ...
    },
    {
      ...
      icon: <FaCrown />, 
      items: ["Kiwi", "Dragonfruit", "Pears","Avocado"],
      theme: "bg-purple-50 border-purple-100 text-purple-800",
      tagTheme: "bg-white text-purple-600 border-purple-200"
    },
    {
    ...
    },
    {
      ...
      icon: <FaLeaf />, 
      items: ["Soaked Almonds", "Dates", "Walnuts", "Cashews", "Figs", "Pistachios"],
  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        <div className="inline-flex p-4 text-green-600">
           <img style={{width:"150px"}} src="/assets/aarogya-logo-1.jpeg" alt="Aarogya Harvest" className="w-full h-full object-cover" />
        </div>
...
const FreshnessTimeline = () => {
  const steps = [
    ...
    { time: "Today, 3:00 AM", title: "Arrives at Kitchen", desc: "Fresh stock reaches our central kitchen. Quality checked instantly.", icon: <FaWarehouse />, color: "bg-blue-100 text-blue-600 border-blue-200" },
    { time: "Today, 4:30 AM", title: "Ozone Wash & Cut", desc: "Purified using Ozone technology. Hand-cut by hygiene-certified staff.", icon: <FaWater />, color: "bg-cyan-100 text-cyan-600 border-cyan-200" },
    { time: "Today, 6:00 AM", title: "Out for Delivery", desc: "Packed in temperature-controlled vans to maintain crunch.", icon: <FaTruck />, color: "bg-green-100 text-green-600 border-green-200" },
    { time: "Today, 8:00 AM", title: "At Your Doorstep", desc: "Silent delivery. Wake up to a bowl of pure health.", icon: <FaHome />, color: "bg-emerald-100 text-emerald-600 border-emerald-200" }
  ];
        ...
        <div className="bg-green-900 rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center gap-12">
           ...
           <div className="relative w-full md:w-1/2 h-64 md:h-80 bg-green-800/50 rounded-3xl border border-green-700/50 backdrop-blur-sm overflow-hidden flex items-center justify-center group cursor-pointer">
               <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 bg-green-500/20 rounded-full animate-ping absolute"></div>
                  <div className="w-48 h-48 bg-green-500/20 rounded-full animate-ping absolute delay-75"></div>
                  <div className="relative z-10 bg-white p-4 rounded-full shadow-xl">
                     <FaHome className="text-4xl text-green-600" />
                  </div>
               </div>
               <div className="absolute bottom-6 left-0 right-0 text-center">
                  <p className="text-green-100 font-bold tracking-widest text-sm">SERVING HYDERABAD</p>
               </div>
           </div>
        </div>
      </div>
...
export default function Home() {
  ...
  // --- ACTION HANDLER ---
  const handleLiveUpdateAction = (actionId) => {
    if (actionId === 'wholesale') {
      setShowRatesModal(true);
    } else if (actionId === 'gym') {
      const message = "Hi Aarogya Harvest! I'm interested in the Gym Protein Bowl subscription. Please share details.";
      window.open(`https://wa.me/919392814951?text=${encodeURIComponent(message)}`, '_blank');
    } else if (actionId === 'refer') {
      const shareText = "Hey! Check out Aarogya Harvest for premium fresh fruit bowls delivered daily. 100% natural and preservative-free. Order here: https://aarogya-harvest-ochre.vercel.app/";
  ...
  return (
    <div ref={containerRef} className="bg-[#fdfcf6] min-h-screen font-sans text-slate-900 selection:bg-green-400 selection:text-white">
      ...
      {/* ================== HERO SECTION ================== */}
      <section style={{marginTop:"-52px"}} className="relative pt-12 pb-12 md:pt-32 md:pb-16 overflow-hidden">
      ...
      {/* ================== LIVE UPDATES ================== */}
      <LiveUpdateSection onAction={handleLiveUpdateAction} />
      ...
      {/* ================== FOOTER ================== */}
      <section className="relative pt-10 pb-10 px-4 md:px-6 bg-[#fdfcf6]">
            ...
            >
              ...
              <div className="bg-blue-600 p-6 text-white relative shrink-0">
                ...
                <div className="flex items-center gap-3">
                   <div className="p-3 bg-white/20 rounded-xl"><FaTag size={24}/></div>
                   <div>
                      <h2 className="text-2xl font-black">Wholesale Rates</h2>
                      <p className="text-blue-100 text-sm">Beat the market price.</p>
                   </div>
                </div>
              </div>
    ...
    ₹{item.ourPrice}
              ...
              <div className="p-6 border-t border-slate-100 bg-white text-center shrink-0">
                 ...
                 <button 
                    ...
                    className="w-full py-3 bg-blue-600 text-white rounded-xl font-bold shadow-lg hover:bg-blue-700 transition-transform active:scale-95"
                 >
                    Build Your Basket
                 </button>
              </div>
